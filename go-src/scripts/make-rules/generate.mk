...
gen.ca: ## 生成 CA 文件.
	...
	@openssl req -new -nodes -key $(OUTPUT_DIR)/cert/ca.key -sha256 -days 3650 -out $(OUTPUT_DIR)/cert/ca.csr \
		-subj "/C=CN/ST=Shanghai/L=Shenzhen/O=pachirode/OU=it/CN=127.0.0.1/emailAddress=pachirode@gmail.com"
	...
	@openssl req -new -key $(OUTPUT_DIR)/cert/server.key -out $(OUTPUT_DIR)/cert/server.csr \
		-subj "/C=CN/ST=Shanghai/L=Shenzhen/O=serverdevops/OU=serverit/CN=localhost/emailAddress=pachirode@gmail.com" \
